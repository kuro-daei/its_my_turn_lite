...
- [06. GitHub チーム招待](#06-github-チーム招待)
  - [目次](#目次)
  ...
  - [3. Claude の中での作業（Collaborator 招待）](#3-claude-の中での作業collaborator-招待)
    - [Step 1：GitHub にリポジトリを作る](#step-1github-にリポジトリを作る)
    - [Step 2：リポジトリを初期化して push する](#step-2リポジトリを初期化して-push-する)
    - [Step 2.5：CLAUDE.md を作成する](#step-25claudemd-を作成する)
    - [Step 3：Collaborator を招待する](#step-3collaborator-を招待する)
