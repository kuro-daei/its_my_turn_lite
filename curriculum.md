...
| 2 | [`05_claude_usage.md`](./05_claude_usage.md) | Claude Code 入門 | Claude への指示・会話形式の操作・基本ワークフロー | — |
| 3 | [`06_agent_workflow.md`](./06_agent_workflow.md) | AI エージェント活用 | MCP 設定・Superpowers・自律エージェントへの依頼 | — |
| 4 | [`07_research_with_claude.md`](./07_research_with_claude.md) | Claude でリサーチ | 情報収集・整理・Markdown メモ作成 | `info/overview.md`（企業概要）`info/contacts.md`（担当者一覧） |
...
| 7 | [`10_research_team.md`](./10_research_team.md) | チームでリサーチ | 役割分担・Claude でリサーチ・まとめ | `info/overview.md` `info/contacts.md` | 4章の復習＋チーム化 |
| 8 | [`11_github_publish.md`](./11_github_publish.md) | GitHub に公開（チーム） | push・PR の基本をチームで体験 | `info/` を GitHub に公開 | 5章の復習＋チーム化 |
| 9 | [`12_markdown.md`](./12_markdown.md) | Markdown | 記法・VS Code プレビュー・ミーティングメモ作成 | `meetings/2025-01-meeting.md` | 新規 |
| 10 | [`13_branch_strategy.md`](./13_branch_strategy.md) | ブランチ戦略 | GitHub Flow・命名規則・Branch Protection Rules | 各自ブランチで `info/` を分担編集 | 5章の復習＋チーム化 |
| 11 | [`14_pull_request.md`](./14_pull_request.md) | Pull Request | PR作成・レビュー・コメント・マージ | チームで PR をレビューし合う | 5章の復習＋チーム化 |
| 12 | [`15_conflict.md`](./15_conflict.md) | コンフリクト解決 | 意図的コンフリクト発生・解決・学習 | 同一ファイルをチームで編集し解消 | 新規 |
