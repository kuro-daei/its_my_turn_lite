# 03. 事前準備（Windows 版）— 開発環境のセットアップ

> [!NOTE]
> **macOS をお使いの方へ:** [02_preparation_mac.md](./02_preparation_mac.md) を参照してください。
...
> [!WARNING]
> Windows 10 の場合、Home / Pro / Education のいずれのエディションでも WSL 2 を使用できます。
...
> [!WARNING]
> `wsl --install` を実行すると、Ubuntu が既定のディストリビューションとして自動インストールされます。
...
> [!WARNING]
> VS Code は **Windows 側**にインストールします。WSL の中ではありません。
