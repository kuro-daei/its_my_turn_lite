...
- [07. チームでリサーチ](#07-チームでリサーチ)
  - [目次](#目次)
  - [1. チームでリサーチする流れ](#1-チームでリサーチする流れ)
  - [2. 役割分担を決める](#2-役割分担を決める)
  - [3. 各自が担当するファイルを Claude で作成](#3-各自が担当するファイルを-claude-で作成)
    - [Aさんの作業：企業概要（overview.md）](#aさんの作業企業概要overviewmd)
    - [Bさんの作業：製品情報（products.md）](#bさんの作業製品情報productsmd)
  - [4. 互いの成果を確認する](#4-互いの成果を確認する)
    - [最新の変更を取得する](#最新の変更を取得する)
    - [相手のファイルを確認する](#相手のファイルを確認する)
  - [5. まとめ](#5-まとめ)
...
```
> /research Apple 社の主要製品・サービスをまとめて
```
...
← [前の章: GitHub チーム招待](./09_team_invite.md) ｜ [次の章: Markdown →](./05_markdown.md)
