# 05. 調査結果を GitHub に公開する

前章では Claude を使ったリサーチ方法を学びました。
この章では、まとめた調査メモを **GitHub に公開するまでの完全なワークフロー** を手を動かしながら体験します。
...
Markdown 記法の詳細は [06_markdown.md](./06_markdown.md) で学べます。ここでは基本的な書き方で調査メモを書きましょう。
以下はテンプレートです。
...
次の章では、Git の内部の仕組みと基本概念を深く理解しましょう。

[06_git_internals.md](./06_git_internals.md) — Git の内部仕組みと基本概念
